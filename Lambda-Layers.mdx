---
title: 'Lambda Layers with Python'
date: '2023-12-20'
...
Tutorial for creating python lambda packages with Docker [link](https://www.geeksforgeeks.org/how-to-install-python-packages-for-aws-lambda-layers/)
...
Github repository with list of pre-packaged Lambda compatile Python libraries [link](https://github.com/Miserlou/lambda-packages)
