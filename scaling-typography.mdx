...
&nbsp;&nbsp;&nbsp;&nbsp;Allowing users to select the font sizes that they are most comfortable with, and adjusting automatically to each users preferences is a better standard to go by compared to explicitly settings a font size for all users that is harder to adjust. More accessibility options are always better.
